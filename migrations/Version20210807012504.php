 ...
 */
final class Version20210807012504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, discount_id, name, brand, model, price, color, size, brief_description, description, created_at, updated_at, rate, created_user, updated_user, image, views, quantity FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, discount_id INTEGER DEFAULT NULL, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, brand VARCHAR(255) DEFAULT NULL COLLATE BINARY, model VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, color VARCHAR(255) DEFAULT NULL COLLATE BINARY, size DOUBLE PRECISION DEFAULT NULL, brief_description VARCHAR(255) DEFAULT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, rate INTEGER DEFAULT NULL, created_user VARCHAR(255) DEFAULT NULL COLLATE BINARY, updated_user VARCHAR(255) DEFAULT NULL COLLATE BINARY, image VARCHAR(255) NOT NULL COLLATE BINARY, quantity INTEGER DEFAULT 0, views INTEGER DEFAULT 0, CONSTRAINT FK_D34A04AD4C7C611F FOREIGN KEY (discount_id) REFERENCES discount (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, discount_id, name, brand, model, price, color, size, brief_description, description, created_at, updated_at, rate, created_user, updated_user, image, views, quantity) SELECT id, discount_id, name, brand, model, price, color, size, brief_description, description, created_at, updated_at, rate, created_user, updated_user, image, views, quantity FROM __temp__product');
